...
def stream_from_context(
    ...
    Args:
        context: retrieved chunks from retrieval pipeline
        conversation_context: optional prior conversation history to inject
    ...
    yield from backend.complete_stream(system, user_prompt)
